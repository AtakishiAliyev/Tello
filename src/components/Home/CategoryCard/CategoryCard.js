...
const CategoryCard = ({ image, categoryName, slug }) => {
    const navigate = useNavigate()

    return (
        <div className='category-card_block'>
            <div className='text'>
                <h3>{categoryName}</h3>
                <p>Məhsul sayı: 46</p>
